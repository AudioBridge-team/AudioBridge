...
## [1.3.1] - 20-09-2022
### Changed
- Полностью переработана структура программы: каждый класс был вынесен в соответствующий ему модуль — это структуризирует ведение проекта и упрощает его дальнейшее развитие
